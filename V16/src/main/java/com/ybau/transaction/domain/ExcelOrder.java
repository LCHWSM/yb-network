...
public class ExcelOrder implements Serializable {
    ...
    @Excel(name = "收货人姓名", needMerge = true, width = 20)
    ...
    @Excel(name = "下单方式", needMerge = true, width = 20)
    private String paymentMethodStr;
    @Excel(name = "审核状态", needMerge = true, width = 20)
    private String auditStr;
    @Excel(name = "结算状态", needMerge = true, width = 20)
    private String paymentStatusStr;//结算状态 中文
    private int expressOnly;//发货标识
    @Excel(name = "发货状态", needMerge = true, width = 20)
    private String expressOnlyStr;
    private int audit;//审核状态（2审核不通过  1审核通过   3 审核中 4 审核撤销 5 订单已取消）
    @Excel(name = "退货状态", needMerge = true, width = 20)
    private String retreatCargoStr;
    @Excel(name = "是否采集到数据仪表盘", needMerge = true, width = 20)
    ...
    private String name;
    @Excel(name = "订单总金额", needMerge = true, width = 20)
    private double sumMoney;//订单总金额
    @Excel(name = "订单实收金额", needMerge = true, width = 20)
    private double actualMoney;//订单实收金额
    @Excel(name = "订单其他金额", needMerge = true, width = 20)
    private double freight;//订单运费
    private int retreatCargo;//退货标识（1，退货中2，已退货）
    @Excel(name = "已结算金额", needMerge = true, width = 20)
    private double settlementAmount;//已结算金额
    @Excel(name = "结算服务费", needMerge = true, width = 20)
    ...
    @Excel(name = "发票抬头类型", needMerge = true, width = 20)
    ...
    @Excel(name = "发票类型", needMerge = true, width = 20)
