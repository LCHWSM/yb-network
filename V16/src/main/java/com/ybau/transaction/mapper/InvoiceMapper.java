...
public interface InvoiceMapper {
     ...
     * @return
     */
    int findCoun(@Param(value = "map") Map<String, Object> map,@Param(value = "id") String id);
     ...
     * @param id
     */
    void saveinvoicerecord(@Param(value = "map") Map<String, Object> map,@Param(value = "id") String id);
}
