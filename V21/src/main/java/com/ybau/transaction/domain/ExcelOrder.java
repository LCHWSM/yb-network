...
public class ExcelOrder implements Serializable {
    ...
    @Excel(name = "订单编号", needMerge = true, width = 23)
    ...
    @Excel(name = "收货人姓名", needMerge = true, width = 8)
    private String receiverName;//收货人姓名
    @Excel(name = "收货人手机号", needMerge = true, width = 13)
    private String receiverMobile;//收货人手机号
    @Excel(name = "收货人地址（省）", needMerge = true, width = 18)
    ...
    @Excel(name = "是否采集到数据仪表盘", needMerge = true, width = 5)
    private String orderSignStr;
    @Excel(name = "申请人", needMerge = true, width = 8)
    private String proposer;//申请人
    @Excel(name = "钉钉单号", needMerge = true, width = 15)
    private String dingNumber;//钉钉单号
    ...
    @Excel(name = "借样订单预计归还时间", format = "yyyy-MM-dd", needMerge = true, width = 12)
    ...
    private String name;
    @Excel(name = "订单总金额", needMerge = true, width = 8)
    private double sumMoney;//订单总金额
    @Excel(name = "订单实收金额", needMerge = true, width = 8)
    private double actualMoney;//订单实收金额
    @Excel(name = "订单其他金额", needMerge = true, width = 8)
    private double freight;//订单运费
    private int retreatCargo;//退货标识（1，退货中2，已退货）
    @Excel(name = "已结算金额", needMerge = true, width = 8)
    private double settlementAmount;//已结算金额
    @Excel(name = "退款金额", needMerge = true, width = 8)
    private double refundAmount;//已结算金额
    @Excel(name = "结算服务费", needMerge = true, width = 8)
    private double serveCost;
    @Excel(name = "订单备注", needMerge = true, width = 20)
    private String orderRemark;//订单备注
    @Excel(name = "发票抬头", needMerge = true, width = 20)
    private String unitName;//公司或个人姓名
    @Excel(name = "发票抬头类型", needMerge = true, width = 8)
    ...
    @Excel(name = "发票类型", needMerge = true, width = 8)
    private String invoiceTypeStr;
    @Excel(name = "快递公司", needMerge = true, width = 17)
