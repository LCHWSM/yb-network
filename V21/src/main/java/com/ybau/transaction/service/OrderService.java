...
//    ResponseData findOrderByDate(Map<String, Object> map) throws Exception;
    ...
    ResponseData turnSell(Map<String, Object> map, HttpServletRequest request) throws ParseException;

    ResponseData proposerMoney(Map<String, Object> map);

    ResponseData leadSales(List<Map<String, Object>> orders, String uId) throws ParseException;
}
